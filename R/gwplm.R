...
#     W.i <- GWmodel::gw.weight(as.numeric(dMat[i,]),bw=bw,kernel=kernel,adaptive=adaptive) # Calcul des poids
#     W.i <- base::diag(W.i)
#     W.i <- base::kronecker(W.i,diag(t)) # On cree la matrice W en dimensions nT
#     wMat[i,] <- base::diag(W.i)
